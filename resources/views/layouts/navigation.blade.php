                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        @elseif(auth()->user()->user_role_id === 4)
                            <x-nav-link :href="route('old-student.dashboard')" :active="request()->routeIs('old-student.*')">
                                Dashboard
                            </x-nav-link>
                        @endif
                    @endauth
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                @elseif(auth()->user()->user_role_id === 4)
                    <x-responsive-nav-link :href="route('old-student.dashboard')" :active="request()->routeIs('old-student.*')">
                        Dashboard
                    </x-responsive-nav-link>
                @endif
            @endauth
